...
## This is a modernized fork of the Ident Rainbow vscode extension.

<b>Features:</b>
<ul>
  <li>Ported from es6 to esnext</li>
  <li>Modern bun build system. The original extension is 3.2 mb. This version is less than 13 kilobytes.</li>
  <li>Upgraded dependencies</li>
  <li>Stricter type system</li>
  <li>webp icon</li>
  <li>Native oklab support though direct editing of the settings json file (untested yet)</li>
</ul>
